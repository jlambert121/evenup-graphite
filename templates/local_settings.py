...
#####################################
TIME_ZONE = "<%= scope.lookupvar('::timezone') %>"
...
RRD_DIR = '/data/graphite/carbon/whisper/rrd'
#DATA_DIRS = [WHISPER_DIR, RRD_DIR] # Default: set from the above variables
LOG_DIR = '/var/log/graphite-web/'
INDEX_FILE = '/data/graphite/carbon/index'  # Search index file
